...
cnn.load_state_dict(torch.load("trained_cnn_letters.pth", weights_only=True))
...
while True:
    ...
    if prop > 0.5:
        cv2.putText(frame, f"Prediction: {Letters[num_pred]}", (50,50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 3, cv2.LINE_AA)
