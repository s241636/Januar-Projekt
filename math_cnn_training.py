...
training_loader = NetUtils.get_dataloader("MNIST_MATH", train=True, batch_size=1000)
testing_loader = NetUtils.get_dataloader("MNIST_MATH", train=False, batch_size=300)
